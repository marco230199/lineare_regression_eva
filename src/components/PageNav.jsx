...
export default function PageNav({ page, setPage, theme, toggleTheme }) {
  return (
    <div style={{ maxWidth: 720, margin: "0 auto 22px", display: "flex", gap: 8, flexWrap: "wrap", alignItems: 'center' }}>
